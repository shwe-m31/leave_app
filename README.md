...
<picture>
  ...
  <img src="https://capsule-render.vercel.app/api?type=transparent&color=gradient&customColorList=14&height=150&text=Leave%20Management%20System&fontSize=40&fontColor=6d28d9&animation=fadeIn&fontAlignY=55&desc=Full-Stack+HR+Automation+Platform&descAlignY=78&descSize=16&descColor=475569"/>
</picture>
</div>
<div align="center">
...
<details>
<summary><b>📝 Leave Request Module</b></summary>
<br/>
...
<details>
<summary><b>🔄 Request Tracking</b></summary>
<br/>
...
```mermaid
flowchart TD
    A([👤 User Login]) --> B[Access Leave Request Page]
    B --> C[📆 Select Leave Dates via Calendar]
    C --> D[✍️ Enter Leave Reason & Details]
    D --> E[📤 Submit Request]
    E --> F{🛠️ Admin Review}
    F -->|✅ Approved| G[Status Updated → Approved]
    F -->|❌ Rejected| H[Status Updated → Rejected]
    G --> I([📬 User Notified])
    H --> I
```
